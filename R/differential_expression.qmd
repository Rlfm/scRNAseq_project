...
count.mat <- table(retina.scrna.sub$sample, retina.scrna.sub$cell_type)
```
...
retina.cell_type.design <- data.frame(
  status = c("1_ret", "1_ret", "0_heal", "1_ret", "0_heal"),
  condition = c("0_none", "1_fgf", "0_none", "1_fgf", "0_none")
)
