...
```{r}
DimPlot(seurat_object, reduction = "umap", split.by = "sample")
```
...
seurat_ASL1_split <- SplitObject(seurat_ASL1, split.by = "sample")
...
```{r}
Idents(seurat_ASL1_combined) <- "integrated_snn_res.0.2"
DimPlot(seurat_ASL1_combined, reduction = "umap", split = "sample")
